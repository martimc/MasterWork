...
# Slepton masses
datadict['m1000011'] = {'block': 'MASS',     'element': (1000011,1),   'abs' : True}
datadict['m1000015'] = {'block': 'MASS',     'element': (1000015,1),   'abs' : True}
datadict['m2000015'] = {'block': 'MASS',     'element': (2000015,1),   'abs' : True}
...
# Stau mixing angle
datadict['staumix11'] = {'block': 'STAUMIX', 'element': ((1,1),2)}
...
#            datadict['1000023_1000023_' + str(en) + '_NLO_adn']    = {'block': 'PROSPINO_OUTPUT', 'element': ((1000023, 1000023, en),12)}
            ...
            datadict['1000011_-1000011_' + str(en) + '_LO_test'] = {'block': 'PROSPINO_OUTPUT', 'element': ((1000011, -1000011, en),3)}

            # selectron cross section and prospino numerical error
            datadict['1000011_-1000011_' + str(en) + '_NLO_1_relerr'] = {'block': 'PROSPINO_OUTPUT', 'element': ((1000011, -1000011, en),6)}
            datadict['1000011_-1000011_' + str(en) + '_NLO_1']        = {'block': 'PROSPINO_OUTPUT', 'element': ((1000011, -1000011, en),7)}
            # Scale variations, 0.5 and 2 times the central scale
            datadict['1000011_-1000011_' + str(en) + '_NLO_05']     = {'block': 'PROSPINO_OUTPUT', 'element': ((1000011, -1000011, en),8)}
            datadict['1000011_-1000011_' + str(en) + '_NLO_2']      = {'block': 'PROSPINO_OUTPUT', 'element': ((1000011, -1000011, en),9)}
            # PDF variation
            datadict['1000011_-1000011_' + str(en) + '_NLO_pdf']    = {'block': 'PROSPINO_OUTPUT', 'element': ((1000011, -1000011, en),10)}
            # Alpha_s variations, up and down one sigma (PDG)
            datadict['1000011_-1000011_' + str(en) + '_NLO_aup']    = {'block': 'PROSPINO_OUTPUT', 'element': ((1000011, -1000011, en),11)}
            datadict['1000011_-1000011_' + str(en) + '_NLO_adn']    = {'block': 'PROSPINO_OUTPUT', 'element': ((1000011, -1000011, en),12)}
