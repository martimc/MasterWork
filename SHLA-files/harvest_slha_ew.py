...
#            datadict['1000023_1000023_' + str(en) + '_NLO_adn']    = {'block': 'PROSPINO_OUTPUT', 'element': ((1000023, 1000023, en),12)}
            ...
            datadict['2000015_-2000015_' + str(en) + '_LO_test'] = {'block': 'PROSPINO_OUTPUT', 'element': ((2000015, -2000015, en),3)}

            # selectron cross section and prospino numerical error
            datadict['2000015_-2000015_' + str(en) + '_NLO_1_relerr'] = {'block': 'PROSPINO_OUTPUT', 'element': ((2000015, -2000015, en),6)}
            datadict['2000015_-2000015_' + str(en) + '_NLO_1']        = {'block': 'PROSPINO_OUTPUT', 'element': ((2000015, -2000015, en),7)}
            # Scale variations, 0.5 and 2 times the central scale
            datadict['2000015_-2000015_' + str(en) + '_NLO_05']     = {'block': 'PROSPINO_OUTPUT', 'element': ((2000015, -2000015, en),8)}
            datadict['2000015_-2000015_' + str(en) + '_NLO_2']      = {'block': 'PROSPINO_OUTPUT', 'element': ((2000015, -2000015, en),9)}
            # PDF variation
            datadict['2000015_-2000015_' + str(en) + '_NLO_pdf']    = {'block': 'PROSPINO_OUTPUT', 'element': ((2000015, -2000015, en),10)}
            # Alpha_s variations, up and down one sigma (PDG)
            datadict['2000015_-2000015_' + str(en) + '_NLO_aup']    = {'block': 'PROSPINO_OUTPUT', 'element': ((2000015, -2000015, en),11)}
            datadict['2000015_-2000015_' + str(en) + '_NLO_adn']    = {'block': 'PROSPINO_OUTPUT', 'element': ((2000015, -2000015, en),12)}
